...
public class TablaTipoBean implements Serializable {
    ...
    private List<TablaTipo> tipoTipoCliente;
    ...
    private List<SelectItem> siTipoCliente;
    ...
    private void inicializarValores() {
        ...
        tipoTipoCliente = UtilTablaTipo.listaTipos(tablatipos, UtilTablaTipo.TIPO_TIPO_CLIENTE);
        ...
        siTipoCliente = listaItem(tipoTipoCliente);
    }
    ...
    public String descripcionTipoCliente(String tipo) {
        return UtilTablaTipo.descripcionTipo(tipoTipoCliente, UtilTablaTipo.TIPO_TIPO_CLIENTE, tipo);
    }
    ...
    public List<SelectItem> getSiTipoCliente() {
        return siTipoCliente;
    }
